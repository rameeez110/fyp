//
//  StudentAttachmentViewController.swift
//  fyp
//
...
class StudentAttachmentViewController: UIViewController ,UITableViewDelegate , UITableViewDataSource{
    
    @IBOutlet weak var studentAttachmentTableView: UITableView!
